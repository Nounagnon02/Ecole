...
- Name: dashboard.spec.mjs >> Dashboard >> protected routes redirect to login
- Location: e2e/dashboard.spec.mjs:23:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/directeur/dashboard
Call log:
  - navigating to "http://localhost:3000/directeur/dashboard", waiting until "load"
