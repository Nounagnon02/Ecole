...
- Name: dashboard.spec.mjs >> Dashboard >> error pages have correct status codes
- Location: e2e/dashboard.spec.mjs:29:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/404
Call log:
  - navigating to "http://localhost:3000/404", waiting until "load"
