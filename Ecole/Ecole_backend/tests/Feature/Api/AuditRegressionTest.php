...
class AuditRegressionTest extends TestCase
{
    ...
    public function s3_mobile_money_ne_valide_pas_un_paiement_sans_transaction()
    {
        ...
        $eleve = Eleve::factory()->forSchool($ecole)->create();
    ...
    {
        $ecole = Ecole::factory()->create();
        // forSchool() rattache l'élève ET son utilisateur à la même école,
        // sans quoi le scope tenant masque le paiement au compte de test.
        $eleveA = Eleve::factory()->forSchool($ecole)->create();
        $eleveB = Eleve::factory()->forSchool($ecole)->create();
